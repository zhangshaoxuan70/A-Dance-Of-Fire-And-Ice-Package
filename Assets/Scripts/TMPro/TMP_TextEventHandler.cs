...
namespace TMPro
{
	public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler
	{
		...
		{
			if (!TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, UnityEngine.Input.mousePosition, m_Camera))
			{
				return;
			}
			int num = TMP_TextUtilities.FindIntersectingCharacter(m_TextComponent, UnityEngine.Input.mousePosition, m_Camera, visibleOnly: true);
			...
			int num2 = TMP_TextUtilities.FindIntersectingWord(m_TextComponent, UnityEngine.Input.mousePosition, m_Camera);
			...
			int num3 = TMP_TextUtilities.FindIntersectingLine(m_TextComponent, UnityEngine.Input.mousePosition, m_Camera);
			...
			int num4 = TMP_TextUtilities.FindIntersectingLink(m_TextComponent, UnityEngine.Input.mousePosition, m_Camera);
