		...
		private void Update()
		{
			if (ReInput.isReady)
			{
				...
				if (player.GetButtonDown("Fire"))
				{
					...
					Object.Instantiate(bulletPrefab, base.transform.position + b, Quaternion.identity).GetComponent<Rigidbody>().velocity = new Vector3(bulletSpeed * base.transform.right.x, 0f, 0f);
				}
