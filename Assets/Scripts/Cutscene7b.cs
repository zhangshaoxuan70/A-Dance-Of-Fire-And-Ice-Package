...
public class Cutscene7b : TaroCutsceneScript
{
	...
	{
		base.Awake();
		shouldDisplay = (!GCS.seenCutscene5_3 && Persistence.GetTaroStoryProgress() < 6);
		...
		if (shouldDisplay)
		{
			...
			dialog.Add(RDString.Get("neoCosmosStory.T5.3.1"));
			dialog.Add(RDString.Get("neoCosmosStory.T5.3.2"));
		}
